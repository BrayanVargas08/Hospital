...
namespace WebHospital.Vista
{
    public partial class Traslado : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cmbAmbulanciaa.DataSource = ListaAmbulancias;
            cmbAmbulanciaa.DataTextField = "Placa";
            cmbAmbulanciaa.DataValueField = "IdAmbulancia";
            cmbAmbulanciaa.DataBind();
            //
        ...
        protected void btnRegistrarTralado_Click(object sender, EventArgs e)
        {
            ...
            objETraslado.IdAmbulancia = int.Parse(cmbAmbulanciaa.SelectedValue.ToString());
            int idambu = int.Parse(cmbAmbulanciaa.SelectedValue.ToString());
