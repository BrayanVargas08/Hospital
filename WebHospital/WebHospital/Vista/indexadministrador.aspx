    ...
    <div class="page-ttl">
        <div class="layer-stretch">
            <div class="page-ttl-container">
                ...
                <p><a href="#">Home</a> &#8594; <span>Forgot Password</span></p>
            </div>
        </div>
        ...
        <div class="layer-wrapper">
            <div class="form-container">
                ...
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label form-input-icon">
                    ...
                    <label class="mdl-textfield__label" for="forgot-email">Email <em> *</em></label>
                ...
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label form-input-icon form-bot-check">
                    ...
                    <label class="mdl-textfield__label" for="forgot-bot">What is 3 plus 5 = <em> *</em></label>
                    <span class="mdl-textfield__error">Please Enter Correct Value!</span>
                </div>
                <div class="form-submit">
                    <button class="mdl-button mdl-js-button mdl-js-ripple-effect button button-primary">Send Reset Link</button>
                </div>
